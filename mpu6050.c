...
void mpu6050_getNextData(double* axg, double* ayg, double* azg, double* gxds, double* gyds, double* gzds, int16_t ax1 ,int16_t ay1,int16_t az1,int16_t gx1,int16_t gy1,int16_t gz1) {
	int16_t ax = 0;
	int16_t ay = 0;
	int16_t az = 0;
	int16_t gx = 0;
    ...
    *axg = (double)(ax-ax1)/MPU6050_AXGAIN;
    *ayg = (double)(ay-ay1)/MPU6050_AYGAIN;
    *azg = (double)(az-az1)/MPU6050_AZGAIN;
    *gxds = (double)(gx-gx1)/MPU6050_GXGAIN;
	*gyds = (double)(gy-gy1)/MPU6050_GYGAIN;
	*gzds = (double)(gz-gz1)/MPU6050_GZGAIN;
}
