...
#define MPU6050_AXOFFSET -688
#define MPU6050_AYOFFSET -610
#define MPU6050_AZOFFSET -2866
...
extern void mpu6050_getNextData(double* axg, double* ayg, double* azg, double* gxds, double* gyds, double* gzds, int16_t ax1 ,int16_t ay1,int16_t az1,int16_t gx1,int16_t gy1,int16_t gz1);
#endif
